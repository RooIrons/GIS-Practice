...
We need to range check against SABAP2 data, if there are SABAP2 records for the SAFRING ringing locations of the chosen species.This step will remove ringing locations that are completely wrong, such as those that are in the middle of the ocean. 
